...
public class ParameterDefinitionPanel extends MainPanel {
	...
	private void addEvents() {
		panelCodeDefinition.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent e) {
				if (e.getActionCommand().equals(CustomEvent.CODE_DEFINITION_SELECTED)) {
					CodeDefinitionDTO selectedCodeDefinitionDTO = panelCodeDefinition.getSelectedCodeDefinitionDTO();
					panelCodeValue.setSelectedCodeDefinitionDTO(selectedCodeDefinitionDTO);
				}
